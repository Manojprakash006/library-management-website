      ...
      <div style={{ font: FONT.f1 }}>
        ...
        <div className="w-full flex flex-col items-center justify-center bg-linear-to-br from-[#f5f3ff] to-[#fff1f8] px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 text-center">
          ...
          <div className="bg-white shadow px-4 py-2 rounded-full text-xs sm:text-sm mb-6 sm:mb-8 flex items-center gap-2">
            ...
            <span style={{...FONTWEIGHT[700]}} className={`${FONTSIZE[14]} leading-5 bg-linear-to-r from-[#4F39F6] to-[#9810FA] bg-clip-text text-transparent`}>Welcome to City Central Library</span>
          </div>

          <div className="space-y-2 sm:space-y-3 max-w-5xl mx-auto">
            <h1 className=" sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight text-[#101828]"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8 sm:mt-10 w-full sm:w-auto px-4">
            ...
            <button onClick={HandleRegister} className="w-full sm:w-auto px-6 py-2.5 sm:py-3 rounded-lg border border-[#C6D2FF] text-[#4F39F6] hover:bg-purple-50 flex items-center justify-center gap-2 text-sm sm:text-base cursor-pointer">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-12 sm:mt-12 w-full max-w-4xl px-4">
            <div className="bg-white shadow rounded-xl p-6 sm:p-8 text-center">
              ...
              <p className={`text-[#4A5565] text-sm sm:text-base mt-1 ${FONTSIZE[14]} leading-5` } style={{...FONTWEIGHT[700]}}>Books</p>
            </div>

            <div className="bg-white shadow rounded-xl p-6 sm:p-8 text-center">
              <h3
                className="text-2xl sm:text-3xl font-bold bg-linear-to-r from-[#AD46FF] to-[#9810FA] bg-clip-text text-transparent"
              >
                5,000+
              </h3>
              <p className={`text-[#4A5565] text-sm sm:text-base mt-1 ${FONTSIZE[14]} leading-5` } style={{...FONTWEIGHT[700]}}>Members</p>
            </div>

            <div className="bg-white shadow rounded-xl p-6 sm:p-8 text-center sm:col-span-2 lg:col-span-1">
              <h3
                className="text-2xl sm:text-3xl font-bold bg-linear-to-r from-[#F6339A] to-[#E60076] bg-clip-text text-transparent"
              >
                28+
              </h3>
              <p className={`text-[#4A5565] text-sm sm:text-base mt-1 ${FONTSIZE[14]} leading-5` } style={{...FONTWEIGHT[700]}}>Years</p>
            </div>
          </div>
        </div>
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex items-start gap-4 mt-6">
                  <div className="w-10 h-10 bg-purple-100 rounded-xl flex items-center justify-center shrink-0">
                    <img src="src/assets/aboutus/Container (1).png" alt="" className="w-8 h-8" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 mt-4">
                  <div className="w-10 h-10 bg-pink-100 rounded-xl flex items-center justify-center shrink-0">
                    <img src="src/assets/aboutus/Container (2).png" alt="" className="w-8 h-8" />
                  </div>
                  <div>
                ...
                <div className="border border-gray-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-purple-600 text-white rounded-lg flex items-center justify-center shrink-0">
                      <img src={hoursIcon} alt="Hours Icon" className="w-6 h-6" />
                    </div>
                  ...
                  <div className="space-y-3 text-sm sm:text-base text-gray-600">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-[#101828]">9:00 AM - 8:00 PM</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Saturday - Sunday</span>
                      <span className="font-semibold text-[#101828]">10:00 AM - 6:00 PM</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="border flex gap-3 items-start border-gray-200 rounded-xl p-6 shadow-sm">
                  ...
                  <div>
                    ...
                    <button className="mt-4 px-4 py-2 border cursor-pointer flex gap-2 border-[#0000001A] rounded-lg text-sm w-fit hover:bg-gray-50 transition">
                      <img src={DarklocationIcon} alt="Location icon" className="w-4 h-4 " />Get Directions
                    </button>
                  </div>
                </div>
              </div>
        ...
        <div className="w-full bg-blue-50 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 flex-col items-center flex text-center">
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            <div className="p-2 bg-[#FFFFFF] rounded-2xl shadow-2xl w-fit">
              <span className={`${FONTSIZE[14]} leading-5 items-center bg-linear-to-r from-[#4F39F6] to-[#9810FA] bg-clip-text text-transparent`} style={{...FONTWEIGHT[700]}}>
                Quick Search
              </span>
            </div>
            ...
            <div className="bg-white border flex flex-col gap-3 border-gray-200 w-[80%] rounded-xl mt-8 mx-4 sm:mx-6 p-4 sm:p-8 shadow-sm">
              <div className="flex items-center gap-3 bg-gray-100 border border-gray-200 rounded-lg px-4 py-2.5 sm:py-3">
                <img src={searchicon} alt="" className="h-4 w-4 sm:h-5 sm:w-5 shrink-0" />
                <input
                  type="text"
          ...
          <div className="max-w-7xl mx-auto">
            <div className=" sm:mb-10 lg:mb-12 flex flex-col items-start gap-2">
              <div className="w-fit bg-linear-to-r from-[#FAF5FF] to-[#FDF2F8] p-2 gap-2.5 rounded-2xl">
                <span className={`bg-linear-to-r from-[#9810FA] to-[#E60076] bg-clip-text text-transparent ${FONTSIZE[14]} leading-5 `} style={{...FONTWEIGHT[700]}} >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 sm:mb-10 lg:mb-12 flex flex-col items-start gap-2">
              <div className="w-fit bg-[white] p-2 gap-2.5 rounded-2xl -mb-2 shadow-2xl">
                <span className={` bg-linear-to-r from-[#4F39F6] to-[#9810FA] bg-clip-text text-transparent ${FONTSIZE[14]} leading-5 `} style={{...FONTWEIGHT[700]}} >
                  Our Services
                </span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>Book Borrowing</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Borrow physical books for home reading</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>Reading Room</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Quiet spaces for focused reading</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>Digital Library</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Access e-books and online resources</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>E-Books</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Download digital books to your device</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>Study Rooms</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Private rooms for group study</p>
                </div>
              </div>
              ...
              <div className="bg-white shadow-lg rounded-xl p-4 sm:p-6 flex items-center gap-3 sm:gap-4 hover:shadow-xl transition">
                ...
                <div className="flex flex-col gap-4">
                  <h3 className={`font-semibold ${FONTSIZE[18]} leading-7 text-[#101828]`} style={{...FONTWEIGHT[700]}}>Online Reservations</h3>
                  <p className={`${FONTSIZE[14]} leading-5 text-[#4A5565]`} style={{...FONTWEIGHT[400]}}>Request books online, collect easily</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                ...
                <button onClick={() => navigate("/register")} className=" cursor-pointer mt-6 sm:mt-8 px-6 py-2.5 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition flex items-center gap-2 text-sm sm:text-base">
                  <img src={icon3} alt="icon" className="h-3 w-3 sm:h-4 sm:w-4" />
                  Register Now - Free
                </button>
              </div>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20" 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div onClick={() => navigate("/event")} className="text-center mt-8 sm:mt-10 ">
